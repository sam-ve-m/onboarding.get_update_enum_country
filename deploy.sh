fission spec init
fission env create --spec --name onb-br-enum-country-env --image nexus.sigame.com.br/fission-onboarding-br-enum-country:0.1.5 --poolsize 0 --version 3 --imagepullsecret "nexus-v3" --spec
